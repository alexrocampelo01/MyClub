...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-10-2023 a las 18:39:26
...
INSERT INTO `director` (`id_d`, `id_u`, `nom_d`, `apel1_d`, `apel2_d`, `club`, `fecha_eleccion`) VALUES
...
CREATE TABLE `padres` (
  ...
  `apel1_p` int(11) NOT NULL,
  `apel2_p` int(11) NOT NULL,
  `tlf_p` varchar(9) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `usuario`
  MODIFY `id_u` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
COMMIT;
